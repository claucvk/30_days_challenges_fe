...
var onSignOut = function onSignOut(event) {
  event.preventDefault();
  var data = getFormFields(this); // event.target
...
// INDEX CHALLENGES
var onGetChallenges = function onGetChallenges(event) {
  event.preventDefault();
  // const data = getFormFields(this)
  console.log(api);
  api.index().then(ui.getAllChallengesSuccess).catch(ui.getAllChallengesFailure);
};

// SHOW CHALLENGE
var onGetChallenge = function onGetChallenge(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var challenge = data.challenge;
  if (challenge.id.length !== 0) {
    api.show(challenge.id).then(ui.getOneChallengeSuccess).catch(ui.getOneChallengeFailure);
  } else {
...
var onCreateChallenge = function onCreateChallenge(event) {
  event.preventDefault();
  var data = getFormFields(event.target); // event.target

  api.create(data).done(ui.onCreateSuccess).fail(ui.onCreateFailure);
};
// DELETE CHALLENGE
var onDeleteChallenge = function onDeleteChallenge(event) {
  ...
  if (challenge.id.length !== 0) {
    api.destroy(challenge.id).then(ui.deleteChallengeSuccess).catch(ui.deleteChallengeFailure);
  } else {
    console.log('Please provide a challenge id!');
  }
};
...
// UPDATE CHALLENGE
var onUpdateChallenge = function onUpdateChallenge(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
...
// CREATE DIARY
var onCreateDiary = function onCreateDiary(event) {
  event.preventDefault();
  var data = getFormFields(event.target); // event.target
  api.createDiary(data).done(ui.onCreateDiarySuccess).fail(ui.onCreateDiaryFailure);
};

// INDEX DIARIES
var onGetDiaries = function onGetDiaries(event) {
  ...
  // const data = getFormFields(this)
  console.log(api);
  api.indexDiaries(data).then(ui.getAllDiariesSuccess).catch(ui.getAllDiariesFailure);
};

// SHOW DIARY
var onGetDiary = function onGetDiary(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var diary = data.diary;
  if (diary.id.length !== 0) {
    api.showDiary(diary.id).then(ui.getOneDiarySuccess).catch(ui.getOneDiaryFailure);
  } else {
    console.log('Please provide a challenge id!');
  }
};
...
// DELETE DIARY
var onDeleteDiary = function onDeleteDiary(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var diary = data.diary;

  if (diary.id.length !== 0) {
    api.destroyDiary(diary.id).then(ui.deleteDiarySuccess).catch(ui.deleteDiaryFailure);
  } else {
...
// UPDATE DIARY
var onUpdateDiary = function onUpdateDiary(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  if (data.diary.id.length !== 0) {
    api.updateDiary(data).then(ui.onUpdateDiarySuccess).catch(ui.onUpdateDiaryFailure);
  } else {
...
var challengeEvents = __webpack_require__(2);
...
var config = {
  apiOrigins: {
    production: 'https://immense-sands-36854.herokuapp.com'
  }
};
...
// CREATE DIARY
var createDiary = function createDiary(data) {
  var status = void 0;
  if (data.status === 'on') {
    status = true;
  } else {
...
// INDEX DIARIES
var indexDiaries = function indexDiaries(data) {
...
// SHOW DIARY
var showDiary = function showDiary(id) {
  return $.ajax({
...
// DELETE DIARY
var destroyDiary = function destroyDiary(id) {
  return $.ajax({
    url: app.host + '/diaries/' + id,
    method: 'DELETE',
    headers: {
...
// UPDATE DIARY
var updateDiary = function updateDiary(data) {
  return $.ajax({
...
module.exports = {
  ...
  indexDiaries: indexDiaries,
  showDiary: showDiary,
  destroyDiary: destroyDiary,
...
var changePasswordFailure = function changePasswordFailure(error) {
  console.log(error);
  var changePasswordFail = $('#changePasswordFail');
...
var onCreateSuccess = function onCreateSuccess() {
  ...
  $('#true').val('');
  $('#false').val('');
  var challengeCreated = $('#challengeCreated');
...
var onUpdateSuccess = function onUpdateSuccess() {
  ...
  $('#trueU').val('');
  $('#falseU').val('');
  var challengeUpdated = $('#challengeUpdated');
...
var onUpdateFailure = function onUpdateFailure(error) {
  console.log(error);
  var challengeUpdateFail = $('#challengeUpdateFail');
...
// Get all challenges
var getAllChallengesSuccess = function getAllChallengesSuccess(data) {
  console.log(data);
  console.log('show all challenges');
  var arrayChallenges = [];
  for (var i in data.challenges) {
    var elementos = 'Challenge Id ' + data.challenges[i].id + ' ' + 'Challenge Name ' + data.challenges[i].name + ' ' + 'Challenge Goal ' + data.challenges[i].goal + ' ' + 'Start day ' + data.challenges[i].start_day + ' ' + 'End day ' + data.challenges[i].end_day + ' ' + 'Challenge Status ' + data.challenges[i].status + '<br>';
    arrayChallenges.push(elementos);
  }
  document.getElementById('allChallenges').innerHTML = arrayChallenges.join(' ');
};

var getAllChallengesFailure = function getAllChallengesFailure(error) {
  console.log(error);
  var allChallengesFail = $('#allChallengesFail');
...
// Get one challenge
var getOneChallengeSuccess = function getOneChallengeSuccess(data) {
  console.log(data.challenge.id);
  var elementos = 'Challenge Id ' + data.challenge.id + ' ' + 'Challenge Name ' + data.challenge.name + ' ' + 'Challenge Goal ' + data.challenge.goal + ' ' + 'Start day ' + data.challenge.start_day + ' ' + 'End day ' + data.challenge.end_day + ' ' + 'Challenge Status ' + data.challenge.status + '<br>';
  document.getElementById('oneChallenge').innerHTML = elementos;
  $('#challenge-id-yo').val('');
};

var getOneChallengeFailure = function getOneChallengeFailure(error) {
  console.log(error);
  var oneChallengeFail = $('#oneChallengeFail');
...
var deleteChallengeSuccess = function deleteChallengeSuccess(data) {
  console.log(data);
  var deleteChallenge = $('#deleteChallenge');
...
var deleteChallengeFailure = function deleteChallengeFailure(error) {
  console.log(error);
  var deleteChallengeFail = $('#deleteChallengeFail');
...
// CREATE DIARY
var onCreateDiarySuccess = function onCreateDiarySuccess() {
  console.log('New diary created');
  $('#challenge-id').val('');
  $('#date').val('');
  $('#description').val('');
  var diaryCreated = $('#diaryCreated');
...
var onCreateDiaryFailure = function onCreateDiaryFailure(error) {
  console.log(error);
  $('#challenge-id').val('');
  $('#date').val('');
  $('#description').val('');
...
// INDEX DIARY
var getAllDiariesSuccess = function getAllDiariesSuccess(data) {
  console.log('ui');
  console.log(data);
  var arrayDiaries = [];
  for (var i in data.diaries) {
    var elementos = 'Diary ID ' + data.diaries[i].id + ' ' + 'Challenge ID ' + data.diaries[i].challenge.id + ' ' + 'Date ' + data.diaries[i].day + ' ' + 'Description ' + data.diaries[i].description + ' ' + 'Diary Status ' + data.diaries[i].status + '<br>';
...
var getAllDiariesFailure = function getAllDiariesFailure(error) {
  console.log(error);
  var allDiariesFail = $('#allDiariesFail');
...
// SHOW DIARY
var getOneDiarySuccess = function getOneDiarySuccess(data) {
  $('#diary-id').val('');
  var elementos = 'Diary ID ' + data.diary.id + ' ' + 'Challenge ID ' + data.diary.challenge.id + ' ' + 'Date ' + data.diary.day + ' ' + 'Description ' + data.diary.description + ' ' + 'Diary Status ' + data.diary.status + '<br>';
  document.getElementById('oneDiary').innerHTML = elementos;
  console.log(data.diary.id);
};

var getOneDiaryFailure = function getOneDiaryFailure(error) {
  console.log(error);
  var oneDiaryFail = $('#oneDiaryFail');
...
// DELETE DIARY
var deleteDiarySuccess = function deleteDiarySuccess(data) {
  console.log('se borró? ', data);
  var deleteDiary = $('#deleteDiary');
...
var deleteDiaryFailure = function deleteDiaryFailure(error) {
  console.log(error);
  var deleteDiaryFail = $('#deleteDiaryFail');
...
// UPDATE DIARY
var onUpdateDiarySuccess = function onUpdateDiarySuccess() {
  console.log('You successfully updated the diary!');
  $('#diary-idU').val('');
  $('#diary-dateU').val('');
  $('#description-diaryU').val('');
  var diaryUpdated = $('#diaryUpdated');
...
var onUpdateDiaryFailure = function onUpdateDiaryFailure(error) {
  console.log(error);
  $('#diary-idU').val('');
  $('#diary-dateU').val('');
  $('#description-diaryU').val('');
  var diaryUpdatedFail = $('#diaryUpdatedFail');
...
module.exports = {
  ...
  getAllChallengesSuccess: getAllChallengesSuccess,
  getAllChallengesFailure: getAllChallengesFailure,
  getOneChallengeSuccess: getOneChallengeSuccess,
  getOneChallengeFailure: getOneChallengeFailure,
  deleteChallengeSuccess: deleteChallengeSuccess,
  deleteChallengeFailure: deleteChallengeFailure,
  onCreateDiarySuccess: onCreateDiarySuccess,
  onCreateDiaryFailure: onCreateDiaryFailure,
  getAllDiariesSuccess: getAllDiariesSuccess,
  getAllDiariesFailure: getAllDiariesFailure,
  getOneDiarySuccess: getOneDiarySuccess,
  getOneDiaryFailure: getOneDiaryFailure,
  deleteDiarySuccess: deleteDiarySuccess,
  deleteDiaryFailure: deleteDiaryFailure,
  onUpdateDiarySuccess: onUpdateDiarySuccess,
  onUpdateDiaryFailure: onUpdateDiaryFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
// module
exports.push([module.i, "body {\n  font-family: 'Lato', sans-serif;\n}\nheader {\n  background-image: url(\"https://i.imgur.com/ak5zxH5.jpg\");\n  padding: 20px 0 20px 0;\n  border-radius: 10px;\n}\nh1 {\n  color: white;\n  background-color: rgba(25,25,25, 0.7);\n  padding: 35px 5px 35px 5px;\n  margin-left: 100px;\n  margin-right: 110px;\n  border-radius: 5px;\n  font-size: 50px;\n  box-shadow: 10px 10px 15px #161615;\n  font-family: 'Nosifer', cursive;\n}\n\n.navbar {\n  font-size: 20px;\n}\n\n.profile {\n  padding: 20px;\n}\n\n.container {\n  width: 100%;\n  max-width: 1100px;\n  margin: 0 auto;\n  margin-top: 40px;\n  display: grid;\n  grid-template-rows: auto;\n  grid-template-columns: 500px 500px;\n  grid-template-areas: \"header  header\" \"menu  menu\" \"content1 content2\" \"content3 content4\" \"footer  footer\";\n  grid-gap: 15px;\n}\n\n.header {\n  grid-area: header;\n  text-align: center;\n  box-shadow: 10px 10px 15px #dddfd4;\n  border-radius: 10px;\n}\n\n.menu {\n  grid-area: menu;\n  border: 1px solid white;\n  text-align: center;\n  box-shadow: 10px 10px 15px #dddfd4;\n  border-radius: 10px;\n}\n\n.content1 {\n  grid-area: content1;\n  border: 1px solid #fae596;\n  text-align: left;\n  background-color: #fae596;\n  box-shadow: 10px 10px 15px #dddfd4;\n  border-radius: 10px;\n}\n.content3 {\n  grid-area: content3;\n  border: 1px solid #3fb0ac;\n  text-align: left;\n  background-color: #3fb0ac;\n  box-shadow: 10px 10px 15px #dddfd4;\n  border-radius: 10px;\n}\n\n.footer {\n  grid-area: footer;\n  text-align: center;\n  box-shadow: 10px 10px 15px #dddfd4;\n  border-radius: 10px;\n  font-size: 20px;\n}\n\n.content2 {\n  grid-area: content2;\n  border: 1px solid #fae596;\n  text-align: left;\n  background-color: #fae596;\n  box-shadow: 10px 10px 15px #dddfd4;\n  border-radius: 10px;\n}\n.content4 {\n  grid-area: content4;\n  border: 1px solid #3fb0ac;\n  text-align: left;\n  background-color: #3fb0ac;\n  box-shadow: 10px 10px 15px #dddfd4;\n  border-radius: 10px;\n}\n\n@media (max-width: 1100px) and (min-width: 316px) {\n  .container {\n    display: grid;\n    grid-template-rows: auto;\n    grid-template-columns: 100%;\n    grid-template-areas: \"header\" \"menu\" \"content1\" \"content2\" \"content3\" \"content4\" \"footer\";\n  }\n}\n", ""]);
